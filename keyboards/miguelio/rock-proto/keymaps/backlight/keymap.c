...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  */
    ...
    _______, KC_BRIU, BL_INC, BL_ON, _______, _______, _______, _______, _______, _______, _______, _______, _______,    _______,   KC_PWR, \
    _______,   KC_BRID, BL_DEC, BL_OFF, _______, _______, _______, _______, _______, _______, _______, _______, _______,   _______, KC_SLEP, \
