...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BL] = LAYOUT_65_iso(
    ...
    KC_LSFT, KC_NUBS, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT, KC_SLSH,   KC_RSFT,   KC_UP, MO(_LL), \
    KC_LCTL, KC_LGUI, KC_LALT,                   KC_SPC,                               KC_RALT, _______, MO(_FL), KC_LEFT, KC_DOWN, KC_RGHT
  ),
  ...
  */
    ...
    _______, _______, KC_BRIU, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,    _______,   KC_PWR, \
    _______,   _______, KC_BRID, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,   _______, KC_SLEP, \
    KC_LSFT, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,   _______,   KC_VOLU, _______, \
    KC_LCTL, KC_LGUI, KC_LALT,                   _______,                                KC_RALT, _______, _______, KC_MUTE, KC_VOLD, KC_MPLY
  ),

  /* Keymap _LL2: RGB Layer
   * ,----------------------------------------------------------------.
   * |   |   |   |   |   |   |   |   |   |   |   |   |   |       |    |
   * |----------------------------------------------------------------|
   * |     |   |   |   |   |   |   |   |   |   |   |   |   |     |    |
