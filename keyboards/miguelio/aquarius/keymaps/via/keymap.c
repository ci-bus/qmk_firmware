...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BL] = LAYOUT_65_iso(
    ...
    KC_LCTL, KC_LGUI, KC_LALT,                   KC_SPC,                             MO(_FS), MO(_FL),          KC_LEFT, KC_DOWN, KC_RGHT
  ),
  ...
  */
    [_FL] = LAYOUT_65_iso(
    KC_A,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12, KC_BRIGHTNESS_DOWN,KC_SYSTEM_WAKE, \
  ...
  [_FS] = LAYOUT_65_iso(
    ...
    RCS(KC_A), _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,      _______,     _______, _______, \
